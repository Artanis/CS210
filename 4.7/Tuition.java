...
public class Tuition {
    public static void main (String[] args) {
        ...
        System.out.println(Tuition.compound(tuition, progression, 1, years));
    ...
    /**
     * This one is so much simpler than that monstrosity up there. Yeah
     * yeah, the chapter's about loops.
     */
    public static double compound(int P, int r, int m, int t) {
        return P * Math.pow(( 1 + ((r / 100.0) / 1.0)),(m * t));
    }
